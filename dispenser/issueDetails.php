...
if(isset($_GET["issue_id"])){
  ...
  $query1 = "select date,patient_id,u_id from dispensary.issues where issue_id='$issue_id'";
  ...
  $u_name = $row3["u_name"];
  $query = "select serial_number,batch_number,amount from dispensary.issue_details where issue_id='$issue_id'";
...
?>
  ...
  <div class="row">
   ...
   <div class="col-md-2">
     ...
     <div class="col-md-3">
       <label><?php echo ":".$patient_id ?></label>
     </div>
   </div>
   <div class="row">
   <div class="col-md-2">
