  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
          <li class=""dropdown">
          <?php
          $query="SELECT * FROM hospital.requests WHERE (sending_dept='2' AND state='0' AND receiving_dept='1') OR (sending_dept='1' AND receiving_dept='0' AND state='3') ORDER BY request_id";//" DESC LIMIT 5";
          ...
          <li class=""dropdown">
          <?php
          $query="SELECT * FROM dispensary.unseen_notifications WHERE status='1' ORDER BY id";//" DESC LIMIT 5";
          $result=mysqli_query($conn,$query);
          $count=mysqli_num_rows($result);
          ?>
