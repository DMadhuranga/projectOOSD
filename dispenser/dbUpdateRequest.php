...
if ($conn) {
    ...
    if($status=='4'){
        $queryNotify="INSERT INTO hospital.notifications (date,message,description,type) VALUES ('$date' ,'Drug Return Order','Your issued drugs were accepted by Dispenser!($request) $comment','2')";
        ...
        $queryNotify="INSERT INTO hospital.notifications (date,message,description,type) VALUES ('$date','Drug Return Order','Your issued drugs were rejected by Dispenser!($request) $comment','2')";
