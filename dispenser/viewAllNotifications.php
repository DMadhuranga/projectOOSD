    ...
    <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <?php
                                    ...
                                    $query_total="SELECT * FROM dispensary.unseen_notifications";
                                ...
                                $query="SELECT * FROM dispensary.unseen_notifications ORDER BY $sort DESC LIMIT $start_from,".$results_per_page;
