...
if (isset($_REQUEST["submitb"])){
  ...
  $inv_level = $_REQUEST["inv_level"];
  $dis_level = $_REQUEST["dis_level"];
  ...
  if (!$error){
    $query = "insert into hospital.drugs (drug_name,serial_number,type,description,dispensary_alert_level,inventory_alert_level) values ('$drugname','$serial','$type','$description','$dis_level','$inv_level')";
    $ins = mysqli_query($conn,$query);
    if ($ins){
...
?>
  ...
  <div class="row">
        <form method ='POST' action="addANewDrug.php">
          ...
          <div class="row">
              <div class="col-sm-6 form-group">
                <label>Inventory Alert Level<span style = "color:red"><?php echo "*";?></label>
                <input name= "inv_level" type="text" placeholder="Enter First Name Here.." class="form-control">
                <label><span style = "color:red"><?php echo $inv_levelErr;?></span></label>
              </div>
              <div class="col-sm-6 form-group">
                <label>Dispensary Alert Level<span style = "color:red"><?php echo "*";?></label>
                <input name="dis_level"  type="text" placeholder="Enter Last Name Here.." class="form-control">
